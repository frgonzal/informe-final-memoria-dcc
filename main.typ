...
#capitulo(title: "Contexto del proceso quirúrgico y situación actual")[
  Este capítulo presenta el contexto del proceso quirúrgico que motiva el trabajo. Primero se revisa la gestión de listas de espera y pabellones desde una perspectiva sanitaria y de gestión hospitalaria. Luego se describe cómo la Plataforma Lahuén representa actualmente el flujo de atención quirúrgica. Finalmente, se identifican las principales limitaciones técnicas de la versión anterior y se explica por qué la modernización debe conservar el flujo funcional, pero reemplazar su mecanismo de implementación.

  == Proceso quirúrgico y listas de espera

  La atención quirúrgica electiva suele organizarse a partir de listas de espera, cuyo origen se relaciona con una demanda asistencial mayor que la capacidad disponible del sistema. Esta capacidad depende de recursos como especialistas, pabellones, camas, financiamiento y otros elementos clínicos necesarios para resolver una intervención @JulioWY2016. En ese contexto, la lista de espera no es solo un registro administrativo: es el punto de entrada de un proceso que debe ordenar pacientes, sostener criterios de priorización y permitir seguimiento hasta la resolución quirúrgica.

  Para este trabajo, el punto relevante no es profundizar en modelos de priorización, sino entender que el proceso quirúrgico comienza antes del ingreso a pabellón. La indicación quirúrgica, la permanencia en lista de espera, la programación de la intervención, la atención en pabellón y el cierre del episodio forman parte de un flujo continuo que un sistema de información debe representar de forma coherente. Por ello, el módulo quirúrgico debe permitir conocer el estado del paciente, registrar eventos relevantes y mantener trazabilidad entre etapas.

  == Situación de pabellones quirúrgicos en Chile

  La gestión quirúrgica también constituye un problema relevante a nivel país. El Sistema Nacional de Servicios de Salud atiende aproximadamente al 80% de la población chilena, por lo que la eficiencia en el uso de pabellones y la gestión de listas quirúrgicas tienen impacto directo sobre la oportunidad de atención de una proporción mayoritaria de la población @CNP2020Quirofanos. En particular, la Comisión Nacional de Productividad identifica que la mayoría de los casos en espera quirúrgica corresponden a prestaciones No GES, alcanzando un 99% de los casos en espera, y que existen brechas importantes entre servicios de salud y hospitales @CNP2020Quirofanos.
  ...
  Los datos del mismo informe muestran brechas relevantes en productividad. Un quirófano electivo promedio en Chile usa 4,8 de 9 horas institucionales, mientras que el referente internacional usado como comparación alcanza 6,4 de 9 horas. Asimismo, Chile realiza cerca de 3,3 cirugías diarias por quirófano, en comparación con 5,1 en el referente considerado, y la primera cirugía comienza en promedio con 40 minutos de retraso @CNP2020Quirofanos. Estos indicadores no se explican únicamente por falta de infraestructura; también se relacionan con programación, preparación de pacientes, coordinación de equipos, suspensiones, trazabilidad e información disponible para la gestión.
